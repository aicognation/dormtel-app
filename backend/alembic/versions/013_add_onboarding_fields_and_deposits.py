...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "dormer_type",
            sa.Enum("student", "reviewee", "working_professional", "other", name="dormer_type"),
            nullable=True,
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "deposit_type",
            sa.Enum("advance", "security", "utility", name="deposit_type"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("paid", "refunded", "forfeited", "pending", name="deposit_status"),
            nullable=False,
            server_default="paid",
        ),

...
@router.post("/meter-readings/validate-template", response_model=TemplateValidationResponse)
...
@router.post("/meter-readings/validate-daily-sheet", response_model=TemplateValidationResponse)
